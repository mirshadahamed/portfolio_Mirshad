  ...
  return (
    <section className="bg-black text-white py-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto px-6">
        {/* Card 1 */}
        <div className="bg-[#1e1e1e] p-8 rounded-2xl hover:scale-105 transition-transform">
          <Image src={img} alt="Web Development" className="w-200 h-200 mb-4" />
        ...
        {/* Card 2 */}
        <div className="bg-[#1e1e1e] p-8 rounded-2xl hover:scale-105 transition-transform">
          <Image src={img1} alt="Mobile Development" className="w-200 h-200 mb-4" />
        ...
        {/* Card 3 */}
        <div className="bg-[#1e1e1e] p-8 rounded-2xl hover:scale-105 transition-transform">
          <Image src={img2} alt="UI/UX Design" className="w-200 h-200 mb-4" />
